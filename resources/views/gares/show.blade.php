         ...
         <div class="card mb-1 shadow-none">
            ...
            <div id="collapseParking" class="collapse"
               ...
               <div class="card-body p-2">
                  <form action="{{ route('parkingGare.store') }}" method="post">
                     @csrf
      ...
      @can('serviceGare-nouveau')
         <div class="card mb-3 shadow-none">
            ...
            <div id="collapseService" class="collapse"
               ...
               <div class="card-body p-2">
                  <form action="{{ route('serviceGare.store') }}" method="post">
                     @csrf
                     <input type="hidden" name="gare_id" value="{{ $gare->id }}">
                  ...
                  <div class="col">
                     <li class="list-group-item p-2 rounded">
                        <div class="row row-cols-2">
                           ...
                           <div class="col">
                              <h6 class=""> {{ $gare->montantJour ?? '-----------' }} &euro;</h6>
                           </div>
                        </div>
                     </li>
                  </div>
                                       ...
                                       <div class="modal-dialog modal-dialog-centered">
                                             <div class="modal-content">
                                                <div class="modal-body p-4">
                                                   <form action="{{ route('serviceGare.destroy',$serviceExiste) }}" method="post">
                                                      @csrf
                                                      @method("DELETE")
   ...
   @can('parkingGare-suppression')
      ...
      <div class="modal fade" id="destroy{{ $parkingExiste->id }}" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
         <div class="modal-dialog">
               <div class="modal-content">
                  <div class="modal-body p-4">
                     <form action="{{ route('parkingGare.destroy',$parkingExiste) }}" method="post">
                        @csrf
                        @method("DELETE")
                        <h6 class="text-center mb-3 fw-bold text-uppercase">
                           suppression de gare ?
